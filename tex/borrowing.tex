...

{
  ...
  \note {
    ...
    Обратите внимание, что код выглядит так, как будто \textbf{написан на
    высокоуровневом языке} программирования, т. е. также, как в Python или Ruby,
    например, \textbf{вызывается метод, создаётся итератор}, но при этом объект
    \textbf{не копируется} (мы передаём ссылку), а следовательно --- нет
    дополнительной аллокации.
